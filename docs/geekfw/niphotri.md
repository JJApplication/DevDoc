# Niphotri
`forked from Trojan-Go`

[![Go Report Card](https://goreportcard.com/badge/github.com/geekfw/niphotri)](https://goreportcard.com/report/github.com/geekfw/niphotri)
...
预编译二进制可执行文件可在 [Release 页面](https://github.com/geekfw/trojan-geek/releases)下载。解压后即可直接运行，无其他组件依赖。
...
- [Igniter-Go](https://github.com/geekfw/trojan-geek-android)：Android 客户端，Fork 自 Igniter，将 Igniter 核心替换为 Trojan-Go 并做了一定修改，支持所有 Trojan-Go 扩展特性。
...
```shell
git clone https://github.com/geekfw/trojan-geek.git
cd trojan-go
make
...
- [ ] 远程配置导入
- [ ] 客户端/服务端分离，类monorepo方式管理
- [ ] AUTOSSL自动申请证书
- [ ] 生成自签名证书
- [ ] 无前置代理时，支持默认监听80端口做前置代理
- [ ] 生成基于Go密码学的交互密钥
- [ ] 默认支持提供基于vless的混淆
